...
<div class="main-content">
  <section class="section">
    ...
    <table id="tb_dokumen" class="table table-hover table-striped table-bordered">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Nama Dokumen</th>
            ...
            <tbody>
                ...
                foreach($dokumen as $dok) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url("admin/dokumen/detail/").$dok->id_dok ?>" class="btn btn-sm btn-warning"><i class="fas fa-eye"></i></a>
                            <a href="<?php echo base_url('admin/dokumen/unduh/'.$dok->id_dok) ?>" class="btn btn-sm btn-success"><i class="fas fa-download"></i></a>
                            <a href="<?php echo base_url("admin/dokumen/edit/").$dok->id_dok ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                            <a href="<?php echo base_url("admin/dokumen/hapus/").$dok->id_dok ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url().'admin/dokumen/filter';?>" method="post" enctype="multipart/form-data">
